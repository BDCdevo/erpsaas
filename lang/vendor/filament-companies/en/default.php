...
return [
    ...
    'errors' => [
        'cannot_leave_school' => 'You may not leave a school that you created.',
        'school_deletion' => 'You may not delete your personal school.',
        ...
        'employee_already_belongs_to_school' => 'This employee already belongs to the school.',
        'employee_already_invited' => 'This employee has already been invited to the school.',
        ...
        'user_belongs_to_school' => 'This user already belongs to the school.',
    ...
    'banner' => [
        'school_invitation_accepted' => 'Great! You have accepted the invitation to join **:school**.',
    ],
    ...
    'notifications' => [
        ...
        'school_created' => [
            ...
            'body' => 'A new school has been created with the name **:name**.',
        ],

        'school_deleted' => [
            'title' => 'School deleted',
            'body' => 'The school **:name** has been deleted.',
        ],

        'school_invitation_sent' => [
            'title' => 'Invitation sent',
            'body' => 'An invitation has been sent to **:email** to join your school.',
        ],

        'school_name_updated' => [
            'title' => 'School updated',
            'body' => 'Your school name has been updated to **:name**.',
        ],
    ...
    'grid_section_titles' => [
        'add_school_employee' => 'Add School Employee',
    ...
    'grid_section_descriptions' => [
        'add_school_employee' => 'Add a new school employee to your school, allowing them to collaborate with you.',
        'browser_sessions' => 'Manage and log out your active sessions on other browsers and devices.',
        'school_name' => "The school's name and owner information.",
        'create_token' => 'Personal Access Tokens allow third-party services to authenticate with our application on your behalf.',
        'create_school' => 'Create a new school to collaborate with others on projects.',
    ...
    'action_section_titles' => [
        'school_employees' => 'School Employees',
        'connected_accounts' => 'Connected Accounts',
        'delete_school' => 'Delete School',
        'pending_school_invitations' => 'Pending School Invitations',
    ],

    'action_section_descriptions' => [
        'school_employees' => 'All of the people that are part of this school.',
        'connected_accounts' => 'Manage and remove your connected accounts.',
        'delete_school' => 'Permanently delete this school.',
        'pending_school_invitations' => 'These people have been invited to your school and have been sent an invitation email. They may join the school by accepting the email invitation.',
    ],
    ...
    'modal_titles' => [
        ...
        'remove_school_employee' => 'Remove School Employee',
        'remove_connected_account' => 'Remove Connected Account',
    ...
    'modal_descriptions' => [
        ...
        'delete_school' => 'Are you sure you want to delete this school?',
        'leave_school' => 'Are you sure you would like to leave this school?',
        'logout_browser_sessions' => 'Please enter your password to confirm you would like to log out of your other browser sessions.',
        'remove_school_employee' => 'Are you sure you would like to remove this person from the school?',
    ...
    'subheadings' => [
        ...
        'companies' => [
            'school_employee_manager' => 'Please provide the email address of the person you would like to add to this school.',
            'delete_school' => 'Once a school is deleted, all of its resources and data will be permanently deleted. Before deleting this school, please download any data or information regarding this school that you wish to retain.',
        ],
    ],
];
