...
return [
    ...
    'labels' => [
        'company_name' => 'اسم المدرسة',
        'company_owner' => 'مالك المدرسة',
    ...
    'errors' => [
        'company_deletion' => 'لا يمكنك حذف مدرستك الشخصية.',
        ...
        'user_belongs_to_company' => 'هذا المستخدم ينتمي بالفعل إلى المدرسة.',
        'employee_already_invited' => 'تم دعوة هذا الموظف بالفعل إلى المدرسة.',
        'employee_already_belongs_to_company' => 'ينتمي هذا الموظف بالفعل إلى المدرسة.',
        'cannot_leave_company' => 'لا يمكنك مغادرة المدرسة التي أنشأتها.',
    ...
    'notifications' => [
        'company_name_updated' => [
            'title' => 'تم تحديث اسم المدرسة',
            'body' => 'تم تحديث اسم مدرستك إلى :name.',
        ],
        'company_invitation_sent' => [
            'title' => 'تم إرسال الدعوة',
            'body' => 'تم إرسال دعوة لـ **:email** للانضمام إلى مدرستك.',
        ],

        'company_created' => [
            'title' => 'تم إنشاء المدرسة',
            'body' => 'تم إنشاء مدرسة جديدة بالاسم **:name.**',
        ],

        'company_deleted' => [
            'title' => 'تم حذف المدرسة',
            'body' => 'تم حذف المدرسة **:name**.',
        ],
    ...
    'navigation' => [
        'headers' => [
            'manage_company' => 'إدارة المدرسة',
            'switch_companies' => 'تغيير الشركات',
        ],

        'links' => [
            'company_settings' => 'إعدادات المدرسة',
            'new_company' => 'مدرسة جديدة',
            'tokens' => 'رموز API',
        ],
    ],
    ...
    'grid_section_titles' => [
        ...
        'company_name' => 'اسم المدرسة',
        'create_company' => 'إنشاء مدرسة جديدة',
        'add_company_employee' => 'إضافة موظف للمدرسة',
    ...
    'grid_section_descriptions' => [
        ...
        'company_name' => 'اسم المدرسة ومعلومات المالك.',
        'create_company' => 'إنشاء مدرسة جديدة للتعاون مع الآخرين في المشاريع.',
        'add_company_employee' => 'إضافة موظف جديد إلى مدرستك للسماح لهم بالتعاون معك.',
        'set_password' => 'تأكد من استخدام حسابك لكلمة مرور عشوائية وطويلة للبقاء آمنًا.',
    ],
    'action_section_titles' => [
        'pending_company_invitations' => 'دعوات المدرسة المعلقة',
        'company_employees' => 'موظفي المدرسة',
        'delete_company' => 'حذف المدرسة',
        'connected_accounts' => 'الحسابات المتصلة',
    ],
    'action_section_descriptions' => [
        'pending_company_invitations' => 'تمت دعوة هؤلاء الأشخاص لمدرستك وتم إرسال رسالة دعوة لهم. يمكنهم الانضمام للمدرسة عن طريق قبول دعوة البريد الإلكتروني.',
        'company_employees' => 'جميع الأشخاص الذين يعملون في هذه المدرسة.',
        'delete_company' => 'حذف هذه المدرسة بشكل دائم.',
    ...
    'modal_titles' => [
        ...
        'leave_company' => 'مغادرة المدرسة',
        'remove_company_employee' => 'إزالة موظف المدرسة',
    ...
    'modal_descriptions' => [
        ...
        'leave_company' => 'هل أنت متأكد أنك تريد مغادرة هذه المدرسة؟',
        'remove_company_employee' => 'هل أنت متأكد أنك تريد إزالة هذا الشخص من المدرسة؟',
        ...
        'delete_company' => 'هل أنت متأكد أنك تريد حذف هذه المدرسة؟ بمجرد حذف المدرسة ، سيتم حذف جميع الموارد والبيانات الخاصة بها بشكل دائم.',
    ...
    'subheadings' => [
        ...
        'companies' => [
            'company_employee_manager' => 'يرجى تقديم عنوان البريد الإلكتروني للشخص الذي ترغب في إضافته إلى هذه المدرسة.',
            'delete_company' => 'بمجرد حذف المدرسة، سيتم حذف جميع الموارد والبيانات الخاصة بها بشكل دائم. قبل حذف هذه المدرسة، يرجى تنزيل أي بيانات أو معلومات ترغب في الاحتفاظ بها.',
        ],
    ],
];
